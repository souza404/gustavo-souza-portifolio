      ...
      <div className="flex gap-3 relative z-10">
        ...
        <div className="bg-[#1a1a1a] border border-white/5 rounded-xl rounded-tl-sm p-3 shadow-md max-w-[85%]">
          ...
          <div className="flex flex-wrap gap-2">
            <button className="px-3 py-1.5 rounded-lg border border-white/10 bg-white/5 text-gray-400 text-[10px] hover:bg-white/10 transition-colors">09:00</button>
            <button className="px-3 py-1.5 rounded-lg border border-rose-500/50 bg-rose-500/10 text-rose-300 text-[10px] font-medium shadow-[0_0_10px_rgba(244,63,94,0.1)]">14:00</button>
            <button className="px-3 py-1.5 rounded-lg border border-white/10 bg-white/5 text-gray-400 text-[10px] hover:bg-white/10 transition-colors">16:30</button>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    <span className="text-[9px] text-gray-400 flex items-center gap-1"><Clock className="w-2.5 h-2.5" /> Sex, 14:00</span>
...
const projects: Project[] = [
  {
    ...
    workflows: [
      ...
      },
      {
        ...
        image: "./public/reativar_agente.png",
      ...
      <main>
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background: useMotionTemplate`radial-gradient(650px circle at ${mouseX}px ${mouseY}px, rgba(120, 50, 255, 0.1), transparent 80%)`,
            }}
          />
            ...
            <div className="flex justify-center">
              {projects.map((project) => (
                <motion.div
                  ...
                  className="group relative w-full max-w-5xl cursor-pointer perspective-1000 will-change-transform"
                >
